...
public class Staff_option extends javax.swing.JFrame {
    public Staff_option() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        insertButton.setText("INSERT ATTENDANCE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Staff_option.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
